...
fit <- stap_glm(y ~ sex + stap(Fast_Food), subject_data = subject_data,
...
```{r}
rbind(fit$ses,fit_125$ses,fit_5$ses)
```

We start to see some bias, as we should, in addition to increased noise, since 
we're increasingly missing ``important'' data that is related to the outcome.
