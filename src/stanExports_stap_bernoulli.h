...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(824, 23, "end", "/model/make_eta_bern.stan");
    reader.add_event(824, 103, "restart", "model_stap_bernoulli");
    reader.add_event(843, 122, "include", "/model/priors_glm.stan");
    reader.add_event(843, 0, "start", "/model/priors_glm.stan");
    reader.add_event(944, 101, "end", "/model/priors_glm.stan");
    reader.add_event(944, 123, "restart", "model_stap_bernoulli");
    reader.add_event(958, 137, "include", "/model/make_eta_bern.stan");
    reader.add_event(958, 0, "start", "/model/make_eta_bern.stan");
    reader.add_event(981, 23, "end", "/model/make_eta_bern.stan");
    reader.add_event(981, 138, "restart", "model_stap_bernoulli");
    reader.add_event(1006, 161, "end", "model_stap_bernoulli");
    return reader;
}
...
class model_stap_bernoulli
  : public stan::model::model_base_crtp<model_stap_bernoulli> {
private:
        int K;
        std::vector<int> N;
        int NN;
