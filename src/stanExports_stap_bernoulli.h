...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(578, 21, "end", "/data/data_glm.stan");
    reader.add_event(578, 37, "restart", "model_stap_bernoulli");
    reader.add_event(592, 51, "include", "/data/hyperparameters.stan");
    reader.add_event(592, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(621, 29, "end", "/data/hyperparameters.stan");
    reader.add_event(621, 52, "restart", "model_stap_bernoulli");
    reader.add_event(622, 53, "include", "/data/glmer_stuff.stan");
    reader.add_event(622, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(637, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(637, 54, "restart", "model_stap_bernoulli");
    reader.add_event(655, 72, "include", "/tdata/tdata_glm.stan");
    reader.add_event(655, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(677, 22, "end", "/tdata/tdata_glm.stan");
    reader.add_event(677, 73, "restart", "model_stap_bernoulli");
    reader.add_event(681, 77, "include", "/parameters/parameters_glm.stan");
    reader.add_event(681, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(696, 15, "end", "/parameters/parameters_glm.stan");
    reader.add_event(696, 78, "restart", "model_stap_bernoulli");
    reader.add_event(699, 81, "include", "/tparameters/tparameters_bernoulli.stan");
    reader.add_event(699, 0, "start", "/tparameters/tparameters_bernoulli.stan");
    reader.add_event(781, 82, "end", "/tparameters/tparameters_bernoulli.stan");
    reader.add_event(781, 82, "restart", "model_stap_bernoulli");
    reader.add_event(801, 102, "include", "/model/make_eta_bern.stan");
    reader.add_event(801, 0, "start", "/model/make_eta_bern.stan");
    reader.add_event(828, 27, "end", "/model/make_eta_bern.stan");
    reader.add_event(828, 103, "restart", "model_stap_bernoulli");
    reader.add_event(847, 122, "include", "/model/priors_glm.stan");
    reader.add_event(847, 0, "start", "/model/priors_glm.stan");
    reader.add_event(949, 102, "end", "/model/priors_glm.stan");
    reader.add_event(949, 123, "restart", "model_stap_bernoulli");
    reader.add_event(963, 137, "include", "/model/make_eta_bern.stan");
    reader.add_event(963, 0, "start", "/model/make_eta_bern.stan");
    reader.add_event(990, 27, "end", "/model/make_eta_bern.stan");
    reader.add_event(990, 138, "restart", "model_stap_bernoulli");
    reader.add_event(1015, 161, "end", "model_stap_bernoulli");
    return reader;
}
