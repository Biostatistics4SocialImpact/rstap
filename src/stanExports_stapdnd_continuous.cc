...
#include "stanExports_stapdnd_continuous.h"

RCPP_MODULE(stan_fit4stapdnd_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_stapdnd_continuous")
