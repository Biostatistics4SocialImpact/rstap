...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(663, 25, "end", "/data/NKZ.stan");
    reader.add_event(663, 8, "restart", "model_stap_continuous");
    reader.add_event(669, 14, "include", "/data/data_glm.stan");
    reader.add_event(669, 0, "start", "/data/data_glm.stan");
    reader.add_event(690, 21, "end", "/data/data_glm.stan");
    reader.add_event(690, 15, "restart", "model_stap_continuous");
    reader.add_event(691, 16, "include", "/data/weights_offset.stan");
    reader.add_event(691, 0, "start", "/data/weights_offset.stan");
    reader.add_event(699, 8, "end", "/data/weights_offset.stan");
    reader.add_event(699, 17, "restart", "model_stap_continuous");
    reader.add_event(700, 18, "include", "/data/hyperparameters.stan");
    reader.add_event(700, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(729, 29, "end", "/data/hyperparameters.stan");
    reader.add_event(729, 19, "restart", "model_stap_continuous");
    reader.add_event(730, 20, "include", "/data/glmer_stuff.stan");
    reader.add_event(730, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(745, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(745, 21, "restart", "model_stap_continuous");
    reader.add_event(746, 22, "include", "/data/glmer_stuff2.stan");
    reader.add_event(746, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(751, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(751, 23, "restart", "model_stap_continuous");
    reader.add_event(757, 29, "include", "/tdata/tdata_glm.stan");
    reader.add_event(757, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(779, 22, "end", "/tdata/tdata_glm.stan");
    reader.add_event(779, 30, "restart", "model_stap_continuous");
    reader.add_event(788, 39, "include", "/parameters/parameters_glm.stan");
    reader.add_event(788, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(803, 15, "end", "/parameters/parameters_glm.stan");
    reader.add_event(803, 40, "restart", "model_stap_continuous");
    reader.add_event(812, 49, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(812, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(894, 82, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(894, 50, "restart", "model_stap_continuous");
    reader.add_event(923, 79, "include", "/model/make_eta.stan");
    reader.add_event(923, 0, "start", "/model/make_eta.stan");
    reader.add_event(926, 3, "end", "/model/make_eta.stan");
    reader.add_event(926, 80, "restart", "model_stap_continuous");
    reader.add_event(940, 94, "include", "/model/eta_no_intercept.stan");
    reader.add_event(940, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(944, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(944, 95, "restart", "model_stap_continuous");
    reader.add_event(979, 130, "include", "/model/priors_glm.stan");
    reader.add_event(979, 0, "start", "/model/priors_glm.stan");
    reader.add_event(1080, 101, "end", "/model/priors_glm.stan");
    reader.add_event(1080, 131, "restart", "model_stap_continuous");
    reader.add_event(1092, 143, "include", "/model/make_eta.stan");
    reader.add_event(1092, 0, "start", "/model/make_eta.stan");
    reader.add_event(1095, 3, "end", "/model/make_eta.stan");
    reader.add_event(1095, 144, "restart", "model_stap_continuous");
    reader.add_event(1096, 145, "include", "/model/eta_add_Wb.stan");
    reader.add_event(1096, 0, "start", "/model/eta_add_Wb.stan");
    reader.add_event(1104, 8, "end", "/model/eta_add_Wb.stan");
    reader.add_event(1104, 146, "restart", "model_stap_continuous");
    reader.add_event(1120, 162, "include", "/model/eta_no_intercept.stan");
    reader.add_event(1120, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(1124, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(1124, 163, "restart", "model_stap_continuous");
    reader.add_event(1145, 182, "end", "model_stap_continuous");
    return reader;
}
...
class model_stap_continuous
  : public stan::model::model_base_crtp<model_stap_continuous> {
private:
        int N;
        int K;
        int Q;
