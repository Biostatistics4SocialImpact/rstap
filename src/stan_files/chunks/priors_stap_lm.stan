...
// intercept priors
    ...
    else if(prior_intercept >= 4 && prior_intercept <=8){ 
...
// beta_one priors
    ...
    else if(prior_beta_one >= 4 && prior_beta_one <=8){ 
...
// beta_two priors 
    ...
    else if(prior_beta_two >= 4 && prior_beta_two <=8){ 
        print("This prior is not yet implimented");
    }
...
// sigma_priors
    ...
    else if(prior_sigma >= 4 && prior_sigma <=8){ 
        print("This prior is not yet implimented");
    }
...
// theta_priors
    ...
    for(q_ix in 1:q){
        ...
        else if(prior_theta[q_ix] >= 4 && prior_theta <=8){ 
            print("This prior is not yet implimented");
        }
