/* for multiple .stan files */
     ...
     * @param M a matrix
     * @return a matrix whose columns are centered and scaled by their mean and sd respectively
    */
   ...
   /** Retrieve Column Means for a Matrix
    * @param M a matrix
    * @return a vector whose values are the means for each column of M
   */
   vector colmeans(matrix M){
        vector[rows(M)] ones= rep_vector(1.0,rows(M));
