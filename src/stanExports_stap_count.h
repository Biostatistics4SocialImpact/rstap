...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(479, 25, "end", "/data/NKZ.stan");
    reader.add_event(479, 8, "restart", "model_stap_count");
    reader.add_event(481, 10, "include", "/data/data_glm.stan");
    reader.add_event(481, 0, "start", "/data/data_glm.stan");
    reader.add_event(502, 21, "end", "/data/data_glm.stan");
    ...
    reader.add_event(542, 29, "end", "/data/hyperparameters.stan");
    reader.add_event(542, 16, "restart", "model_stap_count");
    reader.add_event(543, 17, "include", "/data/glmer_stuff.stan");
    reader.add_event(543, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(558, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(558, 18, "restart", "model_stap_count");
    reader.add_event(559, 19, "include", "/data/glmer_stuff2.stan");
    reader.add_event(559, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(564, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(564, 20, "restart", "model_stap_count");
    reader.add_event(569, 25, "include", "/tdata/tdata_glm.stan");
    reader.add_event(569, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(591, 22, "end", "/tdata/tdata_glm.stan");
    reader.add_event(591, 26, "restart", "model_stap_count");
    reader.add_event(595, 30, "include", "/parameters/parameters_glm.stan");
    reader.add_event(595, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(610, 15, "end", "/parameters/parameters_glm.stan");
    reader.add_event(610, 31, "restart", "model_stap_count");
    reader.add_event(616, 37, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(616, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(698, 82, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(698, 38, "restart", "model_stap_count");
    reader.add_event(730, 70, "include", "/model/make_eta.stan");
    reader.add_event(730, 0, "start", "/model/make_eta.stan");
    reader.add_event(733, 3, "end", "/model/make_eta.stan");
    reader.add_event(733, 71, "restart", "model_stap_count");
    reader.add_event(734, 72, "include", "/model/eta_add_Wb.stan");
    reader.add_event(734, 0, "start", "/model/eta_add_Wb.stan");
    reader.add_event(742, 8, "end", "/model/eta_add_Wb.stan");
    reader.add_event(742, 73, "restart", "model_stap_count");
    reader.add_event(748, 79, "include", "/model/eta_no_intercept.stan");
    reader.add_event(748, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(752, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(752, 80, "restart", "model_stap_count");
    reader.add_event(788, 116, "include", "/model/priors_glm.stan");
    reader.add_event(788, 0, "start", "/model/priors_glm.stan");
    reader.add_event(889, 101, "end", "/model/priors_glm.stan");
    reader.add_event(889, 117, "restart", "model_stap_count");
    reader.add_event(906, 134, "include", "/model/make_eta.stan");
    reader.add_event(906, 0, "start", "/model/make_eta.stan");
    reader.add_event(909, 3, "end", "/model/make_eta.stan");
    reader.add_event(909, 135, "restart", "model_stap_count");
    reader.add_event(910, 136, "include", "/model/eta_add_Wb.stan");
    reader.add_event(910, 0, "start", "/model/eta_add_Wb.stan");
    reader.add_event(918, 8, "end", "/model/eta_add_Wb.stan");
    reader.add_event(918, 137, "restart", "model_stap_count");
    reader.add_event(928, 147, "include", "/model/eta_no_intercept.stan");
    reader.add_event(928, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(932, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(932, 148, "restart", "model_stap_count");
    reader.add_event(958, 172, "end", "model_stap_count");
    return reader;
}
...
class model_stap_count
  : public stan::model::model_base_crtp<model_stap_count> {
private:
        int N;
        int K;
        int Q;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (size_t i_0__ = 0; i_0__ < theta_s_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_lb_unconstrain(0, theta_s[i_0__]);
            } catch (const std::exception& e) {
        ...
        for (size_t i_0__ = 0; i_0__ < theta_t_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_lb_unconstrain(0, theta_t[i_0__]);
            } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (size_t d_0__ = 0; d_0__ < theta_s_d_0_max__; ++d_0__) {
                if (jacobian__)
                    theta_s.push_back(in__.scalar_lb_constrain(0, lp__));
                else
                    theta_s.push_back(in__.scalar_lb_constrain(0));
            }
            current_statement_begin__ = 603;
            ...
            for (size_t d_0__ = 0; d_0__ < theta_t_d_0_max__; ++d_0__) {
                if (jacobian__)
                    theta_t.push_back(in__.scalar_lb_constrain(0, lp__));
                else
                    theta_t.push_back(in__.scalar_lb_constrain(0));
            }
            current_statement_begin__ = 606;
