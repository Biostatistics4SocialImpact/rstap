...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(519, 21, "end", "/data/data_glm.stan");
    reader.add_event(519, 13, "restart", "model_stap_binomial");
    reader.add_event(520, 14, "include", "/data/weights_offset.stan");
    reader.add_event(520, 0, "start", "/data/weights_offset.stan");
    reader.add_event(528, 8, "end", "/data/weights_offset.stan");
    reader.add_event(528, 15, "restart", "model_stap_binomial");
    reader.add_event(530, 17, "include", "/data/hyperparameters.stan");
    reader.add_event(530, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(559, 29, "end", "/data/hyperparameters.stan");
    reader.add_event(559, 18, "restart", "model_stap_binomial");
    reader.add_event(560, 19, "include", "/data/glmer_stuff.stan");
    reader.add_event(560, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(575, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(575, 20, "restart", "model_stap_binomial");
    reader.add_event(576, 21, "include", "/data/glmer_stuff2.stan");
    reader.add_event(576, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(581, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(581, 22, "restart", "model_stap_binomial");
    reader.add_event(585, 26, "include", "/tdata/tdata_glm.stan");
    reader.add_event(585, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(607, 22, "end", "/tdata/tdata_glm.stan");
    reader.add_event(607, 27, "restart", "model_stap_binomial");
    reader.add_event(611, 31, "include", "/parameters/parameters_glm.stan");
    reader.add_event(611, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(626, 15, "end", "/parameters/parameters_glm.stan");
    reader.add_event(626, 32, "restart", "model_stap_binomial");
    reader.add_event(629, 35, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(629, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(711, 82, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(711, 36, "restart", "model_stap_binomial");
    reader.add_event(728, 53, "include", "/model/make_eta.stan");
    reader.add_event(728, 0, "start", "/model/make_eta.stan");
    reader.add_event(731, 3, "end", "/model/make_eta.stan");
    reader.add_event(731, 54, "restart", "model_stap_binomial");
    reader.add_event(732, 55, "include", "/model/eta_add_Wb.stan");
    reader.add_event(732, 0, "start", "/model/eta_add_Wb.stan");
    reader.add_event(740, 8, "end", "/model/eta_add_Wb.stan");
    reader.add_event(740, 56, "restart", "model_stap_binomial");
    reader.add_event(746, 62, "include", "/model/eta_no_intercept.stan");
    reader.add_event(746, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(750, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(750, 63, "restart", "model_stap_binomial");
    reader.add_event(758, 71, "include", "/model/priors_glm.stan");
    reader.add_event(758, 0, "start", "/model/priors_glm.stan");
    reader.add_event(859, 101, "end", "/model/priors_glm.stan");
    reader.add_event(859, 72, "restart", "model_stap_binomial");
    reader.add_event(871, 84, "include", "/model/make_eta.stan");
    reader.add_event(871, 0, "start", "/model/make_eta.stan");
    reader.add_event(874, 3, "end", "/model/make_eta.stan");
    reader.add_event(874, 85, "restart", "model_stap_binomial");
    reader.add_event(875, 86, "include", "/model/eta_add_Wb.stan");
    reader.add_event(875, 0, "start", "/model/eta_add_Wb.stan");
    reader.add_event(883, 8, "end", "/model/eta_add_Wb.stan");
    reader.add_event(883, 87, "restart", "model_stap_binomial");
    reader.add_event(893, 97, "include", "/model/eta_no_intercept.stan");
    reader.add_event(893, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(897, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(897, 98, "restart", "model_stap_binomial");
    reader.add_event(907, 106, "end", "model_stap_binomial");
    return reader;
}
...
class model_stap_binomial
  : public stan::model::model_base_crtp<model_stap_binomial> {
private:
        int N;
        int K;
        int Q;
