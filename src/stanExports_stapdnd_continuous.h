...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(952, 4, "end", "/model/make_dnd_eta.stan");
    reader.add_event(952, 68, "restart", "model_stapdnd_continuous");
    reader.add_event(966, 82, "include", "/model/eta_no_intercept.stan");
    reader.add_event(966, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(970, 4, "end", "/model/eta_no_intercept.stan");
    reader.add_event(970, 83, "restart", "model_stapdnd_continuous");
    reader.add_event(1005, 118, "include", "/model/priors_glm.stan");
    reader.add_event(1005, 0, "start", "/model/priors_glm.stan");
    reader.add_event(1106, 101, "end", "/model/priors_glm.stan");
    reader.add_event(1106, 119, "restart", "model_stapdnd_continuous");
    reader.add_event(1118, 131, "include", "/model/make_dnd_eta.stan");
    reader.add_event(1118, 0, "start", "/model/make_dnd_eta.stan");
    reader.add_event(1122, 4, "end", "/model/make_dnd_eta.stan");
    reader.add_event(1122, 132, "restart", "model_stapdnd_continuous");
    reader.add_event(1132, 140, "end", "model_stapdnd_continuous");
    return reader;
}
...
class model_stapdnd_continuous
  : public stan::model::model_base_crtp<model_stapdnd_continuous> {
private:
        int N;
        int n;
        int K;
