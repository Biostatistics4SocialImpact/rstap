...
#' (\pkg{loo} package) that provide compatibility for \pkg{rstap} models.
#' 
#' @export
...
loo_predictive_interval.stapreg <-
  function(object,
           prob = 0.9,
           ...,
           psis_object = NULL) {
